                                                        ...
                                                        <div class="col col-md-9">
                                                            <div class="form-check-inline form-check">
                                                                <label for="inline-radio1" class="form-check-label ">
                                                                    <input type="radio" id="inline-radio1" name="radiostatus_tugas" value="0" {{$data->status_kategori==0?"checked":""}} class="form-check-input">Masih Berjalan
                                                                </label>
                                                                <label for="inline-radio2" class="form-check-label ">
                                                                    <input type="radio" id="inline-radio2" name="radiostatus_tugas" value="1"  {{$data->status_kategori==1?"checked":""}} class="form-check-input">Selesai
                                                                </label>
                                                            </div>
                                                        </div>
                                        </div>
